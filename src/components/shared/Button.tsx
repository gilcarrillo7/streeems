	...
	return (
		<>
			...
			{variant === "error" && (
				<button
					type={type}
					className={`${className} text-white font-bold border-2 border-error bg-error py-2 px-8 sm:px-20 h-12 hover:bg-white hover:text-error w-4/5 sm:w-auto mx-auto`}
					onClick={onClick}
				>
					{children}
				</button>
